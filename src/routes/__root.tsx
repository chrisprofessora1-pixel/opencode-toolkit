...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Chris Castelli" },
      ...
      { name: "twitter:site", content: "@profchriscastelli" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;600;700&family=Lora:ital,wght@1,400&family=Sora:wght@700;800&display=swap",
      },
    ],
  }),
